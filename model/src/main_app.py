...
from eda import get_top_words
from similarity_model import SimilarityModel, PredictMatchingScore
from utils import get_destination_path, save_files
from utils import set_up_initial_ui_layout, empty_data_folder
...
def resumes_processing_layout():
    ...
    resume_path = get_destination_path("data\\resumes")
    ...
    uploaded_jds = st.file_uploader("Upload one or more Job Description/s",
                                    accept_multiple_files=True,
                                    type=["pdf"])
    jd_path = get_destination_path("data\\job_descriptions")
...
def resumes_after_processing_layout():
    ...
    with results:
        ...
        output_path = get_destination_path("data\\model_output")
...
def checking_something():
    ...
    folder_path = get_destination_path("data\\model_output")
...
if __name__ == "__main__":
    empty_data_folder("data\\job_descriptions")
    empty_data_folder("data\\resumes")
    main()
